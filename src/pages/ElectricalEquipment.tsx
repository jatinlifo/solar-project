...
const productCategories = [
    {
        ...
        products: [
            ...
            "USB Charging Socket",
            "Smart Touch Switch",
            "Heavy Duty Power Socket",
            "Designer Switch Plate",
        ],
        color: "bg-accent",
    ...
    },
    {
        icon: Cable,
        title: "Wire & Cable",
        description: "High quality electrical wire and cable for safe power transmission in residential and commercial installations.",
